...
public class PlayerInAirState : PlayerState
{
    ...
    public PlayerInAirState(PlayerScript player, PlayerStateMachine stateMachine, PlayerData playerData,
    ...
    private void HandleInAirMovement()
    {
        ...
        player.RB.velocity = new Vector2(player.RB.velocity.x,
            Mathf.Max(player.RB.velocity.y, -playerData.maximumFallingSpeed));
