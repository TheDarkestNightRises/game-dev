...
public class Entity : MonoBehaviour, IDamageable
{
    ...
    {
        return Physics2D.Raycast(wallcheck.position, -transform.right, entityData.wallCheckRange,
            entityData.whatIsGround);
    }

    public bool CheckLedge()
    {
        return Physics2D.Raycast(ledgeCheck.position, Vector2.down, entityData.ledgeCheckRange,
            entityData.whatIsGround);
    }
    ...
    {
        return Physics2D.Raycast(playerCheck.position, -transform.right, entityData.meleeAttackRange,
            entityData.whatIsPlayer);
    }
    ...
    protected virtual void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(wallcheck.position,
            wallcheck.position + (Vector3)(Vector2.right * FacingDirection * entityData.wallCheckRange));
        Gizmos.DrawLine(ledgeCheck.position,
            ledgeCheck.position + (Vector3)(Vector2.right * FacingDirection * entityData.ledgeCheckRange));
    }
}